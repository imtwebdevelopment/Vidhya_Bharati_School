        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <motion.div variants={fadeInUp} className="col-span-1 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              {/* YouTube */}
              <motion.a whileHover={{ scale: 1.2 }} href="#" className="text-gray-300 hover:text-red-600 transition-colors duration-300 p-2 rounded-full hover:bg-white/10">
                <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-1">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-300 text-sm break-words">Yeramaras Camp, RCR, Raichur Pin - 584 135, Karnataka State.</span>
              </div>
